...
# NN
feature_scaler = joblib.load('../models/nn_cstocks_feature_scaler.joblib')
...
with open('../shap/cstocks/nn_shap_values.dill', 'rb') as f:
...
#     plt.savefig(f'../shap/cstocks/summary_plot_RF_{target}.jpg', dpi=300, bbox_inches='tight')
#     plt.close()
    
# # Plot NN shap values
# shap.summary_plot(nn_shap_values[0][:], X_test_scaled_shap)
# plt.savefig('../shap/cstocks/summary_plot_NN_VegC.jpg', dpi=300, bbox_inches='tight')
# plt.close()
# shap.summary_plot(nn_shap_values[1][:], X_test_scaled_shap)
# plt.savefig('../shap/cstocks/summary_plot_NN_SoilC.jpg', dpi=300, bbox_inches='tight')
# plt.close()

# shap.summary_plot(nn_shap_values[2][:], X_test_scaled_shap)
# plt.savefig('../shap/cstocks/summary_plot_NN_LitterC.jpg', dpi=300, bbox_inches='tight')
# plt.close()
...
fig_rf.savefig('../shap/cstocks/summary_plot_RF_targets.jpg', dpi=300, bbox_inches='tight')
fig_nn.savefig('../shap/cstocks/summary_plot_NN_targets.jpg', dpi=300, bbox_inches='tight')
plt.show()
