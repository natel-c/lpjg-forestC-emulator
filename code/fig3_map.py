...
def plot_all_maps(targets, models, path_dir, percent_error, cmap):
    ...
    for col, model in enumerate(models):
        for row, target in enumerate(targets):
            ...
            run_dir = os.path.join(path_dir, 'cstocks', model, 'predictions')
            ...
            # df.time_since_disturbance > 221 because the series is 251 long, and I want to plot
            # the average of the end of the series (2070-2100, last 30 years)
    ...
    plt.savefig(os.path.join(path_dir, 'figures/fig3_cstocks_map.jpg'), dpi=DPI, bbox_inches='tight')
    plt.close()
